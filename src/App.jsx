  ...
  return (
    <div className="card">
      ...
      <div className="space-y-4">
        ...
        <button onClick={handleBooking} className="submit-btn">Book Service</button>
      </div>
  ...
  return (
    <div className="card">
      ...
      <div encType="multipart/form-data">
        ...
        />
        <button onClick={handleUpload} className="submit-btn">Upload</button>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="card">
      ...
      <div className="space-y-4">
        ...
        <button onClick={handleConnect} className="submit-btn">Connect</button>
      </div>
    </div>
  );
}
